...
vi.mock("next-i18next/pages", () => {
  const cockpitByLocale = {
    ja: {
      ...
      "metric.shipping.today_output.total": "今日出力",
      "metric.shipping.active_shops": "稼働店舗",
      "metric.shipping.tomorrow.total": "明日予定",
    ...
    "zh-Hans": {
      ...
      sourceWorst: "{{valid}}/{{total}} · {{source}} {{state}}",
      sourceWorstMore: "{{valid}}/{{total}} · {{source}} {{state}} +{{count}}",
      "metric.shipping.today_output.total": "今日输出",
      "metric.shipping.active_shops": "活跃店铺",
      "metric.shipping.tomorrow.total": "明日计划",
    ...
    en: {
      ...
      sourceWorst: "{{valid}}/{{total}} · {{source}} {{state}}",
      sourceWorstMore: "{{valid}}/{{total}} · {{source}} {{state}} +{{count}}",
      "metric.shipping.today_output.total": "Output today",
      "metric.shipping.active_shops": "Active shops",
      "metric.shipping.tomorrow.total": "Planned tomorrow",
