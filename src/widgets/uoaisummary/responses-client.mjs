...
const SYSTEM_INSTRUCTIONS = [
  ...
  "",
  "Vocabulary:",
  "- output.* counts are 出力 (production output / 输出). This deployment carries no 出荷 (shipment) data at all.",
  "  Never describe any figure as 出荷, 発送, 发货, or shipment.",
  "- performance.* is a once-daily snapshot of the previous business day, not a live feed. Do not present it as current-moment data.",
  "",
  "Action priorities:",
